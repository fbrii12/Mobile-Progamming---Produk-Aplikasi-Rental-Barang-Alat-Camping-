        ...
        <View style={styles.container}>
          <View>
            ...
            <Text style={styles.caption}>
              Let’s log in to your account and roll in to CampRent!
            </Text>
          ...
          <View style={{ gap: 10 }}>
              ...
              style={[
                button.container,
                {
                  backgroundColor: isLoginDisabled
                    ? colors.forestGreen(0.5)
                    : colors.forestGreen(),
                },
              ]}
              underlayColor={colors.forestGreen(0.9)}
              onPress={handleLogin}
            ...
            <View style={{ flexDirection: "row", gap: 5, alignSelf: "center" }}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate("Register")}>
                <Text style={[button.label, { color: colors.forestGreen() }]}>
                  Sign up
                </Text>
              </TouchableOpacity>
            </View>
